...
function sliders () {
  if ($('.owl-carousel').length) {
    ...
    //ADD CoderDojo Tsuruoka original
    $('.nextevents').owlCarousel({
      navigation: false, // Show next and prev buttons
      navigationText: ['<i class="fas fa-angle-left"></i>', '<i class="fas fa-angle-right"></i>'],
      slideSpeed: ($('.nextevents').attr('data-slide-speed') || 2000),
      paginationSpeed: ($('.nextevents').attr('data-pagination-speed') || 1000),
      autoPlay: ($('.nextevents').attr('data-autoplay') || 'true') === 'true',
      stopOnHover: true,
      singleItem: true,
      lazyLoad: false,
      addClassActive: true,
